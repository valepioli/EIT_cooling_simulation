...
# --- PLOT LIMITS ---
# Change these values to zoom on the two plots independently
X_LIMIT_PHONONS = (0, 100000) 
X_LIMIT_POPULATIONS = (0, 100000)
...
def plot_monte_carlo_results():
    ...
    # REMOVED: sharex=True to allow independent X axes
    ...
    ax1.set_xlabel("Time [Arbitrary Units]", fontsize=12) # Added X axis label since they are now independent
