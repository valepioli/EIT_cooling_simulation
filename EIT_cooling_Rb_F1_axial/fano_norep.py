...
def plot_results():
    ...
    # Imposta esplicitamente i limiti dell'asse Y e la notazione scientifica
    ax_zoom.set_ylim(-1e-5, 1e-4)
    ...
    # Imposta esplicitamente i limiti dell'asse Y e la notazione scientifica
    ax_full_unlimited.set_ylim(-1e-5, 1e-4)
    ax_full_unlimited.ticklabel_format(axis='y', style='sci', scilimits=(0,0))
